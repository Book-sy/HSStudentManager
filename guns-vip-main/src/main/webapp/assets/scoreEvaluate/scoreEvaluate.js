layui.use(['table', 'admin', 'ax', 'func'], function () {
    ...
    ScoreEvaluate.initColumn = function () {
        return [[
            ...
            {field: 'scoreId', sort: true, title: '分数id'},
            {field: 'evaluate', sort: true, title: '评价'},
            {field: 'createUser', sort: true, title: '评价人'},
            {field: 'updataTime', sort: true, title: '更新时间'},
            {field: 'createTime', sort: true, title: '评价时间'},
    ...
    ScoreEvaluate.openAddDlg = function () {
        func.open({
            title: '添加',
            content: Feng.ctxPath + '/scoreEvaluate/add',
    ...
    */
    ...
    var tableResult = table.render({
        ...
        url: Feng.ctxPath + '/scoreEvaluate/list',
        page: true,
        height: "full-158",
        cellMinWidth: 100,
